\begin{table*}[t]
\centering
\caption{Eight-task utility under the unified GPT-2/GPU evaluation setting. Higher is better. Plaintext GPT-2 is included only as a utility reference; the secure comparisons are among EncryptedLLM, PolyTransformer, and FreqGPT.}
